...
public interface PropiertarioRepository extends JpaRepository<PropietarioModel, Long> {
    ...
    // 4 consultas query Nativas

    // Mostar los propietarios con las visitantes
    @Query(value = """
    ...
    //Propietario con la reserva de los parqueaderos
    @Query(value = """
    ...
    //Propietario con la reserva de la zona social
    @Query(value = """
    ...
    //Propietario con el visitante y el parqueadero
    @Query(value = """
